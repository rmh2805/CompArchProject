...
# MemRet:
    ...
    0x00 if nyb uR1 0x40 EvalOp
    0x01 if nyb uR1 0x50 EvalOp
    0x02 if nyb uR1 0x60 EvalOp
    0x03 if nyb uR1 0x70 EvalOp
    0x04 if nyb uR1 0x80 EvalOp
    0x05 none; mov uPC uRet
